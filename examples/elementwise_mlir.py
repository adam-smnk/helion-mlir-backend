...
def main():
    ...
    lines = ir_str.split('\n')
    func_lines = [l for l in lines if 'func.func' in l or 'linalg.generic' in l or 'arith' in l]
    print(f"Generated IR snippet: {len(ir_str)} characters")
    print(f"Contains: linalg.generic={('linalg.generic' in ir_str)}, arith operations={('arith' in ir_str)}")
    ...
    ir_str = str(module)
    print(f"Generated IR snippet: {len(ir_str)} characters")
    print(f"Contains: linalg.generic={('linalg.generic' in ir_str)}, scf.forall={('scf.forall' in ir_str)}")
